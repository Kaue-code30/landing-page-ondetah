            ...
            <div className="w-[90%] lg:w-[75%] flex items-center gap-2 justify-center lg:justify-start pt-16 pb-20 lg:pb-[120px] flex-col h-full">
                ...
                <motion.div ref={ref}
                    ...
                    animate={controlsOne} className="w-full lg:flex-row flex-col mt-5 lg:mt-10 lg:h-[630px] gap-10 lg:gap-5 flex">
                    {
                        JsonList.map((i, key) => {
                            return (
                                <div key={key} className={`h-full cursor-default  ${key === 1 ? "scale-y-105 shadow-xl bg-secondColor lg:scale-105 text-textSecondColor" : "mt-2 lg:scale-95"} shadow-md w-full lg:w-[32%] p-10 border rounded-2xl`}>
